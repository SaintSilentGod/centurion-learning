  ...
  return (
    <div className="mx-auto max-w-2xl rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
      ...
      <ul className="mt-4 list-disc space-y-2 pl-6 text-slate-700">
        ...
        <li>Экзамен можно проходить только в одной вкладке браузера</li>
        <li>Нельзя открывать новые вкладки и окна во время экзамена</li>
        <li>Требуется полноэкранный режим и демонстрация всего экрана</li>
